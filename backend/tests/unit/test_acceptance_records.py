...
#: 作业进度通道缺陷修复、M2 交付链复验·作业进度通道修复后、M2 参数系统验收、
#: M2 收口验收·诊断接入界面 + 两处配置项、M2 增补验收·OI-19 分级显隐 + 剖切
#: 〔含其交付链复验〕、M4 计算内核验收〔§16.5〕、M5 完整飞行器验收〔§16.6〕、
#: M6 优化与轨道层验收〔§16.7，2026-09-22 缺项补做后升级〕、M7 交付验收〔§16.8，2026-09-22〕）。
#: 少于它即说明扫描瞎了。
